...
CREATE TABLE "new_ProductSliderSetting" (
    ...
    "thumbnailNavigation" TEXT NOT NULL DEFAULT 'none',
...
INSERT INTO "new_ProductSliderSetting" ("accentColor", "appEnabled", "carouselNavigation", "carouselPerView", "createdAt", "customGallerySelector", "defaultLocale", "hideThumbnails", "hideZoomIcon", "hoverNavigation", "hoverNavigationAxis", "hoverNavigationInvert", "hoverNavigationSpeed", "hoverTransition", "id", "imageTransition", "keyboardNavigation", "lazyLoadImages", "loopSlides", "nextArrowSvg", "previousArrowSvg", "productIds", "products", "replaceThemeGallery", "shop", "stageLayout", "syncVariantImages", "themeProfile", "thumbnailHoverEffect", "thumbnailPosition", "thumbnailShape", "thumbnailSize", "transitionSpeed", "updatedAt", "zoomIconPosition", "zoomIconSvg", "zoomLevel", "zoomTrigger") SELECT "accentColor", "appEnabled", "carouselNavigation", "carouselPerView", "createdAt", "customGallerySelector", "defaultLocale", "hideThumbnails", "hideZoomIcon", "hoverNavigation", "hoverNavigationAxis", "hoverNavigationInvert", "hoverNavigationSpeed", "hoverTransition", "id", "imageTransition", "keyboardNavigation", "lazyLoadImages", "loopSlides", "nextArrowSvg", "previousArrowSvg", "productIds", "products", "replaceThemeGallery", "shop", "stageLayout", "syncVariantImages", "themeProfile", "thumbnailHoverEffect", "thumbnailPosition", "thumbnailShape", "thumbnailSize", "transitionSpeed", "updatedAt", "zoomIconPosition", "zoomIconSvg", "zoomLevel", "zoomTrigger" FROM "ProductSliderSetting";
